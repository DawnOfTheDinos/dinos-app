...
interface DawnOfTheDinosInterface extends ethers.utils.Interface {
  functions: {
...
export class DawnOfTheDinos extends BaseContract {
  ...
  interface: DawnOfTheDinosInterface;
  ...
  callStatic: {
    ...
    pause(_value: boolean, overrides?: CallOverrides): Promise<void>;
